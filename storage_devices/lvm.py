...
class Lvm(Disk):
    ...
    def create(
        ...
        if isinstance(volume_size_or_percent, Size):
            ...
            TestRun.LOGGER.error(f"Incorrect type of first argument (volume_size_or_percent).")
    ...
    def remove(lv_name: str, vg_name: str):
        ...
        if not vg_name:
            raise ValueError("VG name needed for VG remove operation.")
